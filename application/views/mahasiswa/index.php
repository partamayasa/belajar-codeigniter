			...
			<div class="col-md-6">
				<h3>Daftar Mahasiswa</h3>
					<?php if( empty($mahasiswa) ): ?>
						<small  class="form-text text-danger">Data mahasiswa tidak ditemukan.</small>
					<?php endif; ?>
					<ul class="list-group">
						<?php foreach ($mahasiswa as $mhs) : ?>
							<li class="list-group-item">
								<?php echo $mhs['nama']; ?>
								<a href="<?php echo base_url(); ?>mahasiswa/hapus/<?php echo $mhs['id'];?>" class="badge badge-danger float-right" onclick="return confirm('yakin ingin menghapus data?');">hapus</a>
